...
function criarJogador() {
  ...
  var jogadorExistente = listaDeJogadores.find(jogador => jogador.nome === nomeNovoJogador);

  if (jogadorExistente) {
    alert("Este jogador já está na lista!");
    return; // Não faz nada se o jogador já estiver na lista
  }

  // Se o jogador não existe, adiciona à listaDeJogadores
